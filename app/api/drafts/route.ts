...
export async function POST(req: NextRequest) {
  return handle(async () => {
    ...
    const allowed = ["form", "hallCostType", "hallCostValue", "hallCostDate", "hallCostRecipient", "location", "itemCheck", "foodCheck", "foodMetaLite", "paymentEntries", "paymentForm", "invoice", "activeItemType"];
