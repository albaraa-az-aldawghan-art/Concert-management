...
export interface CostItem {
  ...
  /** قناة البيع الأساسية مستقلة عن القسم الفرعي حتى يمكن اختيارها أولاً. */
  salesChannel?: SalesChannel | null;
  /** سعر البيع شامل الضريبة لكل قسم بيع — معرّف SalesSection → سعر.
   *  نفس الصنف قد يُباع بسعر مختلف في كل قسم يظهر فيه. القيمة المُدخَلة
   *  شاملة الضريبة دائماً، وقبل الضريبة يُشتقّ من نسبة الضريبة العامة
   *  وقت العرض — فلا ينحرف لو غيّرت النسبة لاحقاً. */
  ...
  /** الحد الذي يظهر عنده الصنف ضمن تنبيهات انخفاض المخزون. */
  minimumStock?: number;
}
